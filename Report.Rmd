...
As expected, the result is greater in the validation dataset, but only slightly bigger; and in both cases the WMAE (arround $2,500) can be considered rather low - taking into account the scale of the variable.
