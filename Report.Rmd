...
ggplot(train_joined,aes(x= IsHoliday, y= Weekly_Sales)) + geom_point(aes(color=train_joined$IsHoliday)) + geom_smooth()
```
...
ggplot(train_joined,aes(x= Temperature, y= Weekly_Sales)) + geom_point(aes(color=train_joined$Temperature)) + geom_smooth()
