...
# 1. Introduction
Forecasting or making predictions of sales  [@]
This report explains the approach taken to forecast sales for a nationwide retailer in the U.S based on historical sales data for the departments of 45 stores [@dill_bicycle_2003; @dill_bicycle_2003-1; @dill_revisiting_2016; @graefe_improving_2015]. 
...
The class change is done, but I need to change the order from "%Y-%m-%d" to "%d/%m/%Y".
