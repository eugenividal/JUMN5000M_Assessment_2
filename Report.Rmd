...
## 1. Introduction
Forecasting sales is a big challenge for retailers around the world (reference needed).

This report explains the approach taken to forecast sales for a specific case for a nationwide retailer in the U.S.  

The prediction will be based on historical sales data for the departments of 45 stores located in different areas of the U.S. An additional difficulty in the forecasting is the consideration of the effects of promotional activities on sales given the fact that part of the promotion related data is absent from historical records. 
...
The available data sets with each of its features are the following:
